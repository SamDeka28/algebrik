  ...
  const cardData = [
    {
        ...
        description:
          ...
          hoverDescription: "Algebrik unifies trusted services in one platform, minimizing friction and enhancing decision-making.",  
      ...
      },
    {
      ...
      description:
        ...
        hoverDescription: "Seamless integrations and real-time updates ensure your operations remain accurate and compliant.",  
 ...
 
    {
      ...
      description:
        ...
        hoverDescription: "Algebrik automates workflows, reducing approval times and enabling faster service.",  
    ...
    <div className="flex flex-col gap-8 justify-center items-center p-6 md:p-10">
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between items-center gap-[32px] lg:gap-10 w-full max-w-[1200px]">
        <div className="flex flex-col items-center w-full lg:w-1/2">
          <div className="relative cursor-pointer flex flex-col-reverse justify-between p-6 rounded-[20px] shadow-[0_16px_52px_0px_rgba(10,64,108,0.1)] backdrop-blur-lg bg-white/60 border border-[#CAD3E0] w-full max-w-[518px] h-[580px] group">
