...
export default function WhatWeStriveFor() {
  return (
    <div
      className="container mx-auto p-8 flex font-plus-jakarta justify-center items-center"
      style={{
    ...
    >
      <div className="flex items-center gap-12">
        <div className="flex font-plus-jakarta gap-[34.91px]">
          ...
          {/* Second Row */}
          <div className="flex flex-col gap-6 relative top-16">
