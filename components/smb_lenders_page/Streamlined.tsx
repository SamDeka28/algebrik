    ...
    return (
      ...
      <div className="flex flex-col justify-center items-center text-center gap-5 mx-auto md:px-44">
        ...
        <CustomSubtitle
          ...
          text="Empower bank journeys with smarter tools to streamline processes, enhance decision-making, and accelerate banking workflows"
        />
      </div>
      ...
      >
        ...
        <div className="flex md:hidden overflow-x-auto pb-4">
          ...
          <div className="flex flex-nowrap gap-[20px] pb-5">
            {data.cardData.map((card, index) => (
              <div
                key={index}
