...
import { Crown, Target, Shield, Zap, TrendingUp, Clock, CheckCircle, AlertTriangle } from 'lucide-react';
...
const EliteProgramSection = () => {
  ...
  return <section ref={sectionRef} className="relative py-20 lg:py-32 overflow-hidden bg-background">
      {/* Background Elements */}
