        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center min-h-screen">
            ...
            <div className="lg:col-span-8 space-y-8 py-20">
              ...
              <div className={`transition-all duration-1000 delay-400 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>                <div className="space-y-4">
              ...
              {/* Elite CTA */}
              <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-600 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>                <button onClick={scrollToForm} className="btn-primary group inline-flex items-center gap-3 bg-gradient-to-r from-teal-500 to-teal-500 hover:from-teal-600 hover:to-teal-600">
