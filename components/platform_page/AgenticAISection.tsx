        ...
        >
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {modules.map((module, index) => (
              <div
                key={module.title}
                className={`relative rounded-[32px] p-6 md:p-8 hover:bg-[#001637] bg-[#03204B] border-[#274E9B]/60 shadow-[0_18px_40px_rgba(6,18,53,0.45)] transition-transform duration-300 hover:-translate-y-1 
