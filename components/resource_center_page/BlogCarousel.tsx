...
export default function BlogCarousel() {
    ...
    const dynamicData: CarouselItem[] = [
      {
        header: "Blogs",
        cardTitle: "BLOG",
        title: blogs.length > 0 ? blogs[0].title : "Latest Blog Post",
        description: blogs.length > 0 ? (blogs[0].excerpt || "Read our latest insights and thought leadership content.") : "Read our latest insights and thought leadership content.",
        source: blogs.length > 0 ? blogs[0].author : "Algebrik AI",
        image: blogs.length > 0 ? getStrapiMediaUrl(blogs[0].featuredImage) : "/section_images/pankajblog.webp",
        url: blogs.length > 0 ? `/resource-center/${blogs[0].slug}` : "/resource-center",
        target: "_self"
      },
      {
        header: "Webinar",
        cardTitle: "WEBINAR",
        title: "Revolutionizing Lending with AI: Case Studies of Success",
        description: "Learn how companies are leveraging Algebrik AI's platform to streamline loan origination processes, increase efficiency, and drive results in the financial sector.",
        source: "BusinessWire",
        image: "/section_images/place.webp",
        url: "",
        target: "_self",
      },
      {
        header: "News Center",
        cardTitle: "NEWS CENTER",
        title: news.length > 0 ? news[0].title : "Latest News",
        description: news.length > 0 ? (news[0].description || "Stay updated with the latest news and announcements from Algebrik AI.") : "Stay updated with the latest news and announcements from Algebrik AI.",
        source: news.length > 0 ? (news[0].source || news[0].author) : "Algebrik AI",
        image: news.length > 0 ? getStrapiMediaUrl(news[0].image) : "/section_images/blog/prnewswire.jpg",
      ...
      },
      {
        header: "Tools",
        cardTitle: "TOOLS",
        title: tools.length > 0 ? tools[0].title : "Algebrik AI's Loan Origination Platform",
        description: tools.length > 0 ? (tools[0].description || "A detailed overview of Algebrik AI's loan origination platform, including its features, benefits, and how it can help financial institutions streamline their loan processes.") : "A detailed overview of Algebrik AI's loan origination platform, including its features, benefits, and how it can help financial institutions streamline their loan processes.",
        source: "Algebrik AI",
        image: "/section_images/place.webp",
        url: "",
        target: "_self",
  ...
  const carouselDataToUse = dynamicCarouselData.length > 0 ? dynamicCarouselData : carouselData;
  let currentSlide = carouselDataToUse[currentIndex];
          ...
          {currentIndex == 0 &&
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 content-between gap-9 ">
              {blogs.map((blog, index) => (
                <Link
                  key={index}
                  href={`/resource-center/${blog.slug
                    .toLowerCase()
                    .replace(/ /g, "-")}`}
                ...
                >
                  <div className="">
                    <Image
                      src={getStrapiMediaUrl(blog.featuredImage)}
                    ...
                    <p className="font-bold mt-4 text-[20px] text-ellipsis">{blog.title}</p>
                  </div>
