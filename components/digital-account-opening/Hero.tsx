...
export default function DAOHero() {
  const [showContactModal, setShowContactModal] = useState(false);
  const heroContent = {
    header: (
      <>
        <div className="hidden md:flex flex-col">
          <span>Start Lending Right</span>
        </div>
    ...
    subtitle:
      "Launch guided, intuitive borrower journeys across channels—turning form-fills into funded loans with ease.",
    ...
    <div className="w-full">
      ...
      >
        <div className="absolute top-64 mx-auto flex flex-col items-center justify-start gap-[20px]">
          ...
          >
            <span className="relative z-10">Preview the Borrower Journey</span>
