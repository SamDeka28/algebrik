...
export const metadata: Metadata = {
  ...
  description:
    "Stay informed with the latest articles, case studies, and news on AI-driven lending solutions, and discover how Algebrik is leading the industry transformation",
};
