...
export const metadata: Metadata = {
  title: "Algebrik AI | Smarter Auto Lending Operations",
  description: "Elevate the future of auto lending. Automate stipulations to simplify workflows, enhance decision-making, and deliver exceptional borrower experiences.",
};
